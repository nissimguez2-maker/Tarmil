...
export const forumThreads: ForumThread[] = [
  ...
  // -- activities_treks --
  {
    ...
    body: 'Monday morning, 5am from Barra. Need at least one more, ideally 2-3. Medium difficulty, scramble at the top.',
    replyCount: 3,
    followCount: 13,
    pinned: false,
  ...
  },
  {
    ...
    forumId: 'forum-rio-activities-treks',
    authorFriendId: 'maya-ipanema',
    title: 'Gracie Humaitá — drop-in rate?',
    body: 'Training there twice a week. Can guests drop in? What is the day rate?',
    replyCount: 2,
    followCount: 9,
    pinned: false,
    subject: 'activities_treks',
  ...
  // -- activities_treks --
  {
    ...
    body: 'Was there last week. Calm in the morning, choppy after lunch. Anyone in town Oct 29–31?',
    replyCount: 3,
    followCount: 14,
    pinned: true,
    subject: 'activities_treks',
