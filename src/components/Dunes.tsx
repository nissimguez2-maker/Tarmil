 ...
 * as decorative full-bleed elements. Per DA v0.3:
 *   - back  : amber    @ 22%, crest height 100%
 *   - mid   : clay     @ 70-85%, crest height 60%
 *   - front : charcoal @ 75%, crest height 30%
 *
...
export function Dunes({ className }: Props) {
  return (
    ...
    >
      ...
      {/* front — charcoal @ 75%, lowest crest */}
      <path
        d="M 0 200 L 0 150
