...
export function PlannedStopSheet({
  ...
  return (
    <div className="flex h-full flex-col">
      <header className="flex items-start justify-between gap-sm border-b border-cocoa-08 p-md">
        <div className="flex flex-col gap-1">
          <button
            type="button"
            onClick={onBack}
            className="meta-caps inline-flex items-center gap-1 self-start text-cocoa-55 active:text-cocoa"
          >
