  ...
  return (
    <button
      ...
      className={clsx(
        ...
        'border border-charcoal-15 bg-cream text-charcoal shadow-device',
        'active:bg-charcoal-08',
      )}
    >
      ...
      {active && (
        <span
          aria-hidden
          className="absolute -end-0.5 -top-0.5 h-2.5 w-2.5 rounded-full bg-amber ring-2 ring-cream"
        />
      )}
    </button>
  );
