...
export function DensityLegend() {
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-[88px] z-[750] flex justify-center px-md">
      <div className="pointer-events-auto flex max-w-[300px] flex-col items-center gap-1.5 rounded-full bg-cream/95 px-md py-2 shadow-card backdrop-blur">
        <div className="flex w-full items-center gap-sm">
          <span className="meta-caps shrink-0 text-charcoal-55">Quiet</span>
          <span
            ...
            aria-hidden
          />
          <span className="meta-caps shrink-0 text-charcoal">Packed</span>
        </div>
        <span className="text-meta normal-case tracking-normal text-charcoal-55">
