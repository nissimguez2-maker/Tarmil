    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-xs pe-12">
          <p className="meta-caps text-cocoa-55">Home</p>
...
function ResultRow({
  ...
  return (
    ...
    >
      ...
      >
        {flag || <Home size={20} strokeWidth={2} className="text-cocoa-55" />}
      </span>
      ...
      <span className="text-meta uppercase text-copper">Set as home</span>
    </button>
  );
}
