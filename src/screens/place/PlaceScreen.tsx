  ...
  return (
    <Screen>
          ...
          <button
            ...
            className={clsx(
              ...
              saved
                ...
                : 'text-charcoal-55 hover:bg-charcoal-8 hover:text-charcoal active:bg-charcoal-15',
            )}
          >
            <Bookmark
      ...
      <div className="flex flex-col gap-lg p-md pb-xl">
        ...
        <p className="max-w-body text-body text-charcoal">
        ...
        {visits.length > 0 ? (
          ...
          <div className="flex items-center gap-sm">
            ...
            <span className="text-body text-charcoal-70">
              <span className="tnum font-medium text-charcoal">
                {place.friendsKnow}
              </span>{' '}
  ...
  return (
    <div className="flex">
      {Array.from({ length: count }).map((_, i) => (
        <span
          key={i}
          className="-me-2 inline-block h-7 w-7 rounded-full border-2 border-cream bg-charcoal"
        ...
        {visits.map((v, i) => (
          <li
            ...
            className={clsx(
              ...
              i < visits.length - 1 && 'border-b border-charcoal-15',
            )}
          >
            <span
              className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-charcoal font-serif text-body text-cream"
              aria-hidden
            >
              {v.friendInitial}
            </span>
            <span className="flex flex-col">
              <span className="text-body text-charcoal">{v.friendName}</span>
...
function ReviewCard({
  ...
  return (
    <article className="flex flex-col gap-xs rounded-2xl bg-sand shadow-card p-md">
        ...
        <span aria-label={`${stars} stars`} className="flex shrink-0 gap-0.5">
          {Array.from({ length: 5 }).map((_, i) => (
            <Star
              ...
              className={
                i < stars
                  ? 'h-3 w-3 fill-amber text-amber'
                  : 'h-3 w-3 fill-charcoal-15 text-charcoal-15'
              }
              strokeWidth={0}
              aria-hidden
            />
      ...
      <p className="text-body leading-relaxed text-charcoal-70 allow-select">
        {text}
      </p>
    </article>
  );
        ...
        return (
          <li
            ...
            className={clsx(
              ...
              i < friendReviews.length - 1 && 'border-b border-charcoal-15',
            )}
          >
