    ...
    <section className="flex flex-col gap-sm">
      <header className="flex items-baseline justify-between gap-sm">
        ...
        <div className="flex shrink-0 items-center gap-sm">
          <span className="meta-caps text-charcoal-55">
          ...
          {onAdd && !past && (
            <button
              ...
              className={clsx(
                ...
                'border border-charcoal-15 bg-cream text-charcoal-70',
                'transition-[transform,background-color,border-color,color] duration-instant ease-out-quart',
                'hover:border-amber hover:text-amber active:scale-[0.94]',
      ...
      {saves.length === 0 ? (
        filteringEmpty ? (
          ...
          <button
            type="button"
            onClick={onAdd}
            className="rounded-2xl bg-sand p-md text-start text-small leading-snug text-charcoal-70 transition-colors duration-instant ease-out-quart hover:bg-clay/50 active:bg-clay/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber focus-visible:ring-offset-2 focus-visible:ring-offset-cream"
          >
  ...
  return (
    <button
      ...
      className={clsx(
        ...
        'border border-charcoal-15 shadow-card',
        'transition-[transform,background-color,border-color] duration-instant ease-out-quart motion-reduce:transition-none',
        'hover:border-amber hover:bg-cream active:scale-[0.99]',
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber focus-visible:ring-offset-2 focus-visible:ring-offset-cream',
      )}
    >
      <Search
        className="h-4 w-4 shrink-0 text-charcoal-55 group-hover:text-amber"
        strokeWidth={1.8}
        aria-hidden
      />
          ...
          <button
            ...
            className={clsx(
              ...
              active
                ...
                : 'border-charcoal-15 bg-cream text-charcoal-70 hover:border-charcoal-30 hover:text-charcoal',
            )}
          >
            ...
            <span
              className={clsx(
                'tnum text-meta',
                active ? 'text-cream/70' : 'text-charcoal-55',
              )}
            >
              {item.count}
            </span>
  ...
  return (
    <div className="flex flex-col gap-sm rounded-2xl bg-sand p-md shadow-card">
      ...
      <button
        type="button"
        onClick={onDiscover}
        className="self-start rounded-full bg-amber px-md py-2 text-body font-medium text-cream shadow-card transition-[transform,background-color] duration-instant ease-out-quart hover:bg-amber-85 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber focus-visible:ring-offset-2 focus-visible:ring-offset-sand"
      >
        Discover places
      </button>
    </div>
